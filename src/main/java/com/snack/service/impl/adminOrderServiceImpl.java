...
//	@Override
	...
	public PageHelp<DoAdminOrder> selectExportAdminOrder(Map<Object, Object> map) {
		PageHelp<DoAdminOrder> pageUtil=new PageHelp<DoAdminOrder>();
		List<DoAdminOrder> selectAdminOrderLimit = orderDao.selectExportAdminOrder(map);
		int countAdminOrder = orderDao.exportCountAdminOrder(map);
		pageUtil.setList(selectAdminOrderLimit);
		pageUtil.setRecord(countAdminOrder);
		return pageUtil;
	}
