...
@MapperScan(basePackages = { "com.snack.mapper" }, sqlSessionFactoryRef = "sqlSessionFactory")
public class DataSourceConfig {
  ...
  //配置文件里的属性名是不需要写成spring.datasource.xxx的形式的，写成a.b.c.url也没有问题，只要在配置bean时指定前缀为a.b.c
    ...
    public SqlSessionFactory testSqlSessionFactory(@Qualifier("datasource") DataSource dataSource) throws Exception {
        ...
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:com/snack/mapper/*.xml"));
        // 开启驼峰命名转换
