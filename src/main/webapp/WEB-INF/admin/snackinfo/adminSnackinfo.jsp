		...
		$.ajax({
			...
			success : function(datas) {
				...
				for (var i = 0; i < json.length; i++) {
					var data=json[i];
					var op="<option value='"+data.id+"'>"+data.typeName+"</option>";
					$("#sType").append(op);
					$("#sTypeU").append(op);
					$("#sType1").append(op);
				}
...
<body ng-App="adminSnackinfoApp">
 <div ng-controller="adminSnackinfoCtrl">
 		药品名:<input class="text-center" id="sName">
                        ...
                        <form id="adminSnackinfForm">
	                        <table>
					            ...
					            <tr>
						            <td>保质期:</td>
						              <td>
					                	<input type="text" placeholder="请填写月数" id="sQdate">
						              </td>
						            </tr>
					            <tr>
					             <tr>
					            ...
					            <tr>
					             <tr>
						            <td>功效:</td>
						              <td>
					                	<input type="text" placeholder="请填写药品功效" id="sDese">
						              </td>
						            </tr>
						            <tr>
						            <td>类别:</td>
