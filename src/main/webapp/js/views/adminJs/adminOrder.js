var integralModule = angular.module("adminOrderApp",[]);
			...
			function initBind($http, $scope,$timeout) {
				...
				$("#exportAdminOrder").on('click', function () {
					exportExcel();
				})
			...
			function exportExcel(){
				if(confirm("确认导出Excel?")){
					var param="?oId="+$("#oId").val()+"&adUserName="+$("#adUserName").val()+"&oTimeStart="+$("#oTimeStart").val()+"&oTimeEnd="+$("#oTimeEnd").val();
					location.href="/admin/order/exportExcel"+param;
				}
